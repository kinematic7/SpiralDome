            ...
            <React.Fragment>
                ...
                <nav aria-label="Page navigation example">
                    <ul className="pagination justify-content-center" style={ulTop}>
                        ...
                        <li onClick={this.accountAction} className="page-item"><a id="menuAcct" className="page-link" href="#"> <img style={imgIcon} src='../Content/images/account.png'></img> Account</a></li>
